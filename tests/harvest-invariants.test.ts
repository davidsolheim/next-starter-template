...
describe("harvest invariants", () => {
  ...
  test("llms.txt and legal/contact routes exist", () => {
    ...
    expect(read("app/(public)/contact/page.tsx")).toContain('title: "Contact"')
    expect(read("app/(public)/contact/contact-form.tsx")).toContain("/api/contact")
    expect(read("app/(public)/waitlist/page.tsx")).toContain("generateMetadata")
    expect(read("app/(public)/waitlist/page.tsx")).toContain('title: "Waitlist"')
    ...
    expect(read("app/(public)/gallery/page.tsx")).toContain("generateMetadata")
